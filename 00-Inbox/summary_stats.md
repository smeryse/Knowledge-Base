...
### Текущие стрейки
- 🔥 Дней подряд с выполнением задач: **0**
- 📅 Недель без пропусков: **0**

### Список достижений
- [ ] **Первая кровь** — выполнить первую задачу
- [ ] **Разминка** — заработать 50 баллов за день
- [ ] **Марафонец** — выполнить 10 задач за день
- [ ] **Неделька** — 7 дней подряд с задачами
- [ ] **Месяц силы** — 30 дней подряд
- [ ] **Копилка** — накопить 500 баллов
- [ ] **Транжира** — потратить 1000 баллов на награды
- [ ] **Баланс** — иметь 1000+ баллов на счету
- [ ] **Профи** — достичь 5 уровня

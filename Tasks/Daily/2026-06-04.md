...
---
## Задачи на сегодня
- [ ] Подготовка к зачёту по физике: дописать лекции, разобрать тесты и вопросы (+5)
- [ ] Сьесть всю еду до СБ
- [x] Купить шампунь ✅ 2026-06-04
- [x] Купить ручки черные ✅ 2026-06-04
- [x] Купить энергос ✅ 2026-06-04
- [ ] Приготовить одежду для альфафеста
- [ ] Приготовить рюкзак в Темрюк
- [ ] (Время) Пополнить Bybit, вывести на MetaMask, закинуть на OpenRouter (+5)
## Перенесенные задачи

...
date: 2026-06-16
---
**Вторник** | **Неделя:** II (неделя 20)

### 🟥 Экзамен (с преподавателем)
| Время             | Предмет                                      | Преподаватель                 |
| ----------------- | -------------------------------------------- | ----------------------------- |
| 09:30 – 11:00     | Конструирование алгоритмов и структур данных | Шиян В.И.                     |
| 11:00             | Сдача летней практики                        |                               |
| 7:00<br>-<br>7:30 | Подьем, завтрак, сборы                       | [[00-Inbox/Взять с собой.md]] |

---
## Задачи на сегодня

- [ ] Сдать экзамен: Конструирование алгоритмов и структур данных (+40)

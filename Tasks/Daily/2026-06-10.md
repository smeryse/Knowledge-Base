...
date: 2026-06-10
---
**Среда** | **Неделя:** I (неделя 19)

### 🟦 Консультация
| Время | Предмет | Преподаватель | Формат |
|-------|---------|---------------|--------|
| 10:00 – 11:00 | Основы теории вероятностей и статистических методов | Калайдина Г.В. | дист. |

---
## Задачи на сегодня

- [ ] Подготовка к самоэкзамену: Основы теории вероятностей (+20)

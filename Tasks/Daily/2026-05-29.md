...
---
## Задачи на сегодня
- [x] Собрать словарь слов ю1-ю12 ✅ 2026-05-29
- [ ] Нормализовать (up)
- [ ] Разбор [[lab-7#Задача 1. Разрешимость и перечислимость множеств#d) М — множество всех псевдослучайных чисел в диапазоне [0, 1], сформированных программой|7 лаба задача d]]
- [x] Разобрать 6 лабу по ТАЛГ ✅ 2026-05-29
- [ ] Разобрать 7-11 лабу по ТАЛГ
- [ ] Разобрать 28-31 задачи по КАСД
- [ ] Проверить расширение waybar
## Перенесенные задачи

...
date: 2026-06-14
---
**Воскресенье** | **Неделя:** II (неделя 20)

### 🟦 КАСД — День 2 (SQL + Алгоритмы)
| Время       | Тема                                                                         |
| ----------- | ---------------------------------------------------------------------------- |
| 09:00–11:00 | #КАСД Вопросы 39–43: SQL (SELECT, WHERE, GROUP BY, HAVING, JOIN, подзапросы) |
| 11:00–12:00 | #КАСД Вопросы 44–48: представления, роли, PostgreSQL, ACID, MVCC             |
| 12:00–12:30 | 🍽️ Обед                                                                     |
| 12:30–13:00 | #КАСД Вопрос 1: полиномиальное хеширование строк                             |
| 13:00–14:00 | #КАСД Вопросы 2–3: префикс-функция, КМП, Z-функция                           |
| 14:00–14:30 | #КАСД Вопросы 4–5: конечный автомат, бор                                     |
| 14:30–15:30 | #КАСД Вопросы 10–11: паросочетания, алгоритм Куна                            |

---
## Задачи на сегодня

- [ ] 09:00–11:00 Вопросы 39–43: SQL (+5)
- [ ] 11:00–12:00 Вопросы 44–48: представления, PostgreSQL (+3)
- [ ] 12:30–13:00 Вопрос 1: полиномиальное хеширование (+1)
- [ ] 13:00–14:00 Вопросы 2–3: префикс-функция, КМП, Z-функция (+2)
- [ ] 14:00–14:30 Вопросы 4–5: конечный автомат, бор (+1)
- [ ] 14:30–15:30 Вопросы 10–11: паросочетания, алгоритм Куна (+2)

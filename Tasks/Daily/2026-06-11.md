...
date: 2026-06-11
---
**Четверг** | **Неделя:** I (неделя 19)

### 🟥 Самоэкзамен
| Время              | Предмет                                             | Преподаватель                 | Аудитория |
| ------------------ | --------------------------------------------------- | ----------------------------- | --------- |
| 09:30 – 11:00      | Основы теории вероятностей и статистических методов | Калайдина Г.В.                | 149       |
| 20:00<br>-<br>8:00 | Работа Ozon Job                                     |                               |           |
| 7:00<br>-<br>7:30  | Подьем, завтрак, сборы                              | [[00-Inbox/Взять с собой.md]] |           |

---
## Задачи на сегодня

- [ ] Сдать самоэкзамен: Основы теории вероятностей (+30)
- [ ] Снять наличку 2500руб и оплатить летний лагерь Адлер профком кубгу 216 каб также нужна справка об обучении (есть)

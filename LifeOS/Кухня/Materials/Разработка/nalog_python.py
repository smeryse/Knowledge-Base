...
if __name__ == '__main__':
    ...
    qr_code = "t=20260514T1041&s=1554.00&fn=7384440901098503&i=42578&fp=1513502117&n=1"
    ticket = client.get_ticket(qr_code)
    print(json.dumps(ticket, indent=4, ensure_ascii=False))

    client.refresh_token_function()
    qr_code = "t=20260514T1637&s=349.93&fn=7384440901098503&i=42578&fp=1513502117&n="
    ticket = client.get_ticket(qr_code)
    print(json.dumps(ticket, indent=4, ensure_ascii=False))
...
| --- | --- |
| `products` | `LifeOS/Кухня/Products/` |
| `recipes` | `LifeOS/Кухня/Recipes/` |
| `stores` | `LifeOS/Кухня/Stores/` |
| `receipts` | `LifeOS/Кухня/Receipts/` |
| `receipt_items` | `LifeOS/Кухня/Receipt Items/` |
| `pantry_items` | `LifeOS/Кухня/Pantry/` |
| `meal_plans` | `LifeOS/Кухня/Meal Plans/` |
| `cooking_log` | `LifeOS/Кухня/Cooking Log/` |
| `shopping_items` | `LifeOS/Кухня/Shopping List/` |

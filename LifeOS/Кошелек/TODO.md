- Скормить нейронке [[LifeOS/Кошелек/Docs/Ideas.md]]
- Архитектура взаимодействия бота и гитхаба [[LifeOS/Кошелек/Docs/Architecture.md]]
...
- Главная проблема - сейчас структура что-то сердене между базой данных и графическим интерфейсом для пользователя. Мне не нравится это. Давай сначала сделаем логичную структуру, а потом уже поверх мяса натянем кожу, как бы.  
- Главный вопрос - почему у схемы бд одни поля, а по факту мы строим архитектуру по другим полям? Объясни этот момент, чем он обоснован.
- Еще одно замечание. Не нужно делить деньги на разные счета. Объясняю почему. Я могу очень часто перебрасывать деньги между счетами. На одном выгодный кешбек, на другом - вклады. И деньги постоянно то туда то сюда текут. СИстема должна в общем отслеживать сколько сейчас внутри нее денег, а сколько утекло наружу  так скажем. 
- Слишком замудрено и аппаратно сложно постоянно парсить таблицы из файлов. Лучше как раз, как я раньше сказал, сделать по типу бд. 
- 
# Структура проекта

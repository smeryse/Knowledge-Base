...
| `Schema.md` | схема БД |
| `Шпаргалка по категориям и единицам.md` | справочник значений |
| `Ручное добавление товара.md` | fallback-инструкция |
| `Будущая логика планирования.md` | backlog и идеи |

### Вне основной схемы

Это не core БД, а вспомогательные или старые материалы:

| Папка/файл | Статус |
| --- | --- |
| `Разработка/` | служебное |
| `Images/` | вложения/картинки |
| `items/` | не часть текущей основной схемы |
| `Выгодные продукты.md` | старый ручной документ |
| `Человеческий корм.md` | отдельная тематическая заметка |
...
4. `README`, `Schema`, `Шпаргалка`, `Будущая логика` = документация

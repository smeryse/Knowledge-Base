...
| --- | --- |
| `accounts` | `Projects/Кошелек/Accounts/` |
| `categories` | `Projects/Кошелек/Categories/` |
| `cashback_programs` | `Projects/Кошелек/Cashback/` |
| `budgets` | `Projects/Кошелек/Budgets/` |
| `savings_goals` | `Projects/Кошелек/Savings/` |
| `recurring_payments` | `Projects/Кошелек/Recurring/` |
| `monthly_transactions` | `Projects/Кошелек/Monthly/` |
